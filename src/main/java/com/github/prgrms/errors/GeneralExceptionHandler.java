...
public class GeneralExceptionHandler {
    ...
    public ResponseEntity<?> handleIllegalFormatException(Exception e) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        return new ResponseEntity<>(badRequestHandle(HttpStatus.BAD_REQUEST), headers, HttpStatus.BAD_REQUEST);
    }
